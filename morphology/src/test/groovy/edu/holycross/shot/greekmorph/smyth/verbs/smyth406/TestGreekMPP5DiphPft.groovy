...
class TestGreekMPP5DiphPft {
  ...
  void testUnique() {
    //
    def expectedUnique = [
    "λέλειμμαι": [Person.FIRST, GrammaticalNumber.SINGULAR, Tense.PERFECT, Mood.INDICATIVE],
    "λέλειψαι": [Person.SECOND, GrammaticalNumber.SINGULAR, Tense.PERFECT, Mood.INDICATIVE],
    "λέλειπται": [Person.THIRD, GrammaticalNumber.SINGULAR, Tense.PERFECT, Mood.INDICATIVE],
    "λελείμμεθα": [Person.FIRST, GrammaticalNumber.PLURAL, Tense.PERFECT, Mood.INDICATIVE],
  ...
  @Test
  void testDual() {
    MorphologicalAnalysis morph = mp.parseGreekString(new GreekString("λέλειφθον",true))
  ...
  @Test
  void testAmbiguous() {
    MorphologicalAnalysis morph = mp.parseGreekString(new GreekString("λέλειφθε",true))
