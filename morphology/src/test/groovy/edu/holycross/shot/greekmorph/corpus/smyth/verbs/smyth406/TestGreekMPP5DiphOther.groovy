...
class TestGreekMPP5DiphOther {
  ...
  @Test
  void testInfin() {
    MorphologicalAnalysis morph = mp.parseGreekString(new GreekString("λελεῖφθαι",true))
  ...
  @Test
  void testPtcpl() {
    MorphologicalAnalysis morph = mp.parseGreekString(new GreekString("λελειμμένος",true))
