...
class TestGreekNoun1Moira {
  ...
  LiteraryGreekParser mp = new LiteraryGreekParser(fstBinary, umgr)
        ...
        void testUniqueForms(){
          ...
          "μοίρᾳ": [Gender.FEMININE, GrammaticalCase.DATIVE, GrammaticalNumber.SINGULAR],
          "μοῖραν": [Gender.FEMININE, GrammaticalCase.ACCUSATIVE, GrammaticalNumber.SINGULAR],

          "μοιρῶν": [Gender.FEMININE, GrammaticalCase.GENITIVE, GrammaticalNumber.PLURAL],
          "μοίραις": [Gender.FEMININE, GrammaticalCase.DATIVE, GrammaticalNumber.PLURAL],
  ...
  void testAccGen() {
      ...
      GreekString ambiguous = new GreekString("μοίρας",true)
      ...
      morph.analyses.each {
        ...
        void testNomVoc(){
          ...
          GreekString ambiguous = new GreekString("μοίρα",true)
          MorphologicalAnalysis morph = mp.parseGreekString(ambiguous)
          ...
          // Plural:
          GreekString ambiguousPlural = new GreekString("μοῖραι",true)
          ...
          // Singular
          GreekString ambiguousSingular = new GreekString("μοῖρα",true)
            MorphologicalAnalysis morphSing = mp.parseGreekString(ambiguousSingular)
            assert morphSing.analyses.size() == 2
            morphSing.analyses.each {
                MorphForm form = it.getMorphForm()
                assert form.getAnalyticalType() == AnalyticalType.NOUN
                CitableId formIdentification = form.getAnalysis()
                assert nom_voc.contains(formIdentification.getCas())
