...
class TestGreekWPresSubj {
  ...
  // The parser:
  LiteraryGreekParser mp = new LiteraryGreekParser(fstBinary, umgr, 10)

  @Test
  void testSinglePrelim() {
    def expectedUnique = [
    "λύῃς": [Person.SECOND, GrammaticalNumber.SINGULAR, Tense.PRESENT, Mood.SUBJUNCTIVE, Voice.ACTIVE]
    ]
