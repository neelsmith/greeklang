...
class TestGreekMPP5DiphImptv {
  ...
  void testUnique() {
    ...
    "λέλειψο": [Person.SECOND, GrammaticalNumber.SINGULAR, Tense.PERFECT, Mood.IMPERATIVE],
    "λελείφθω": [Person.THIRD, GrammaticalNumber.SINGULAR, Tense.PERFECT, Mood.IMPERATIVE],
    ]
  ...
  @Test
  void testAmbiguous() {
    MorphologicalAnalysis morph = mp.parseGreekString(new GreekString("λελείφθων",true))
